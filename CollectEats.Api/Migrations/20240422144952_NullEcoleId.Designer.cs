...
namespace Hackathon.Api.Migrations
{
    ...
    [Migration("20240422144952_NullEcoleId")]
    partial class NullEcoleId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hackathon.Data.Models.AtelierVisiteur", b =>
                {
                    b.Property<int>("AtelierId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hackathon.Data.Models.AtelierVisiteur", b =>
                {
                    b.HasOne("Hackathon.Data.Models.Atelier", null)
                        .WithMany()
                        .HasForeignKey("AtelierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hackathon.Data.Models.Visiteur", null)
                        .WithMany()
